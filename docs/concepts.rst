...
1. If a *Default Parameters* set is provided, it will form the basis of the Meal Ingredients.
...
2. If you provide a default parameters set, it is an illegal operation to define and set an Ingredient that doesn't exist in it.
   ...
   **Why?:** This is to catch spelling mistakes in the parameter names. However, this functionality can be disabled to
...
3. The Variant Recipes should not re-define an Ingredient that their parent Common Recipe already defined.
   ...
   **Why?:** This is to make it easier to trace which part of the Dish file ends up in the Meal. If you need a Dish Variant
   to alter the value of an Ingredient found in the Common Dish, you can create another Variant and define your Ingredients there.
